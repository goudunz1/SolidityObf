...
from changeFormat import formatting #ADDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDD
...
MODULES = [
    ...
    {"name": "commentDeletion", "enabled": False}, #ADDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDD
    {"name": "identifierRenaming", "enabled": True}, #ADDDDDDDDDDDDDDDDDDDDDDDDDDDDDD
]
...
def main():
    ...
    source_obf = formatting(source_obf) #ADDDDDDDDDDDDDDDDDDDDDDDDDDD
